...
int adventurerCardEffect(struct gameState *state, const int currentPlayer) {
    ...
    while(drawnTreasure < 2) 
    {
      ...
      //printf("silver is %d and gold is %d\n", silver, gold);
      // Adam Condron: added cardDrawn == copper
      ...
      { // Card drawn is not a treasure card. Remove from player's hand.
        //printf("tempHandCount is %d\n", tempHandCount);
